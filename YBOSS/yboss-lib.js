YBOSS = function() {
      ...
      function retrieved(o) {
                ...
                if(typeof o.ysearchresponse.resultset_web !== 'undefined') {
                             ...
                             for(var i=0;i<o.ysearchresponse.resultset_web.length;i++) {
               ...
               if(typeof o.ysearchresponse.resultset_images !== 'undefined') {
                            ...
                            for(var i=0;i<o.ysearchresponse.resultset_images.length;i++) {
               ...
               if(typeof o.ysearchresponse.resultset_news !== 'undefined') {
                            ...
                            for(var i=0;i<o.ysearchresponse.resultset_news.length;i++) {
      ...
      function clean(s) { return encodeURIComponent(s);};
      
      return { get: get, config: config, retrieved: retrieved, appID: appID }
}();